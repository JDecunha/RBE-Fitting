function [output] = Residuals_BWFScaledBetaplotter(kernelName, filePaths, FuncVals)
...
for i = 1:size(GPUExperimentalData.SF,3)
    ...
    betaPredicted = alphaPredicted*FuncVals(end); %last param of FuncVals is beta
    ...
    sfPredictedPlot = sfPredictedPlot - survivingFraction;
    
    survivdata = plot(ax, dosePlot, sfPredictedPlot);
