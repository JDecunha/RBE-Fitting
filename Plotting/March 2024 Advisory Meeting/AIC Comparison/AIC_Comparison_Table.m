...
writecell(outputMatrix ,"AIC_Comparison_Table_November17.csv")

%% Run the AIC calculation script before this

outputMatrix = [AGOAIC; AGOAIC_LET; U87AIC; U87AIC_LET];
outputMatrix = transpose(outputMatrix);
outputMatrix = [{'AGO Delta AIC' 'AGO-LET Delta AIC' 'U87 Delta AIC' 'U87-LET Delta AIC'}; num2cell(outputMatrix)];
writecell(outputMatrix ,"AIC_Comparison_Table_Pristine_December31.csv")