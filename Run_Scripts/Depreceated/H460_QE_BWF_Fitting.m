function [output] = H460_QE_BWF_Fitting()
%% Setup environment
addpath(genpath("."));
...
%% Set up the kernels
CudaKernel = parallel.gpu.CUDAKernel("QEBWF.ptx", "QEBWF.cu");
CudaKernel.ThreadBlockSize = 1024;
CudaPenalty = parallel.gpu.CUDAKernel("QEPenaltyFunction.ptx", "QEPenaltyFunction.cu");
