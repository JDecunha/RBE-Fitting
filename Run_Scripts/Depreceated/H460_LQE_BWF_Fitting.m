function [output] = H460_LQE_BWF_Fitting()
%% Setup environment
addpath(genpath("."));
...
%% Set up the kernels
CudaKernel = parallel.gpu.CUDAKernel("LQEBWF.ptx", "LQEBWF.cu");
CudaKernel.ThreadBlockSize = 1024;
CudaPenalty = parallel.gpu.CUDAKernel("LQEPenaltyFunction.ptx", "LQEPenaltyFunction.cu");
