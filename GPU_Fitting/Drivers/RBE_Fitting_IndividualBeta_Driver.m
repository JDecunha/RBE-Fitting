function [output] = RBE_Fitting_IndividualBeta_Driver(experimentalData, cudaKernel, nAlphaParams, cudaPenaltyKernel, initialGuess,  penaltyWeight, iterationsPerCycle, numCycles, toleranceCycles, dynamicTemp, gradientAssist, temps)
