function [output] = RBE_Fitting_PredeterminedBeta_Driver(experimentalData, cudaKernel, cudaPenaltyKernel, initialGuess, betas, penaltyWeight, iterationsPerCycle, numCycles, toleranceCycles, dynamicTemp, gradientAssist, temps)
...
CostFunc = @(x) GPUCostFunction_PredeterminedBeta(x, betas, experimentalData, penaltyWeight, cudaKernel, GPUBuffer, cudaPenaltyKernel, GPUBuffer2);
