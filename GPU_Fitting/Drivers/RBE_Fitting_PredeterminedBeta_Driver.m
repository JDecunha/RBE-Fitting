function [output] = RBE_Fitting_PredeterminedBeta_Driver(experimentalData, cudaKernel, nAlphaParams, cudaPenaltyKernel, initialGuess, penaltyWeight, iterationsPerCycle, numCycles, toleranceCycles, dynamicTemp, gradientAssist, temps)
...
CostFunc = @(x) GPUCostFunction_PredeterminedBeta(x, experimentalData, nAlphaParams, penaltyWeight, cudaKernel, GPUBuffer, cudaPenaltyKernel, GPUBuffer2);
